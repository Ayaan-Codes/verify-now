// ACO Captha Systems © | Powered by ACO Verification ™ | Used for ACO Oauth Signin | All rights reserved to ACO (Ayaan Company)

function ChangeCaptcha() {
    var chars = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz"; 
    // You can include special characters by adding them to the string above, for eg: chars += "@#?<>";
    
    var string_length = 10; // This is the length of the Captcha
...
function check() { // Function which checks if the entered value is matching the Captcha
    if(document.getElementById('CaptchaEnter').value == document.getElementById('randomfield').value ) {
        ...
        window.open('https://website.smb.company','_self');
